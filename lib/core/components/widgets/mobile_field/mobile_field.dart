...
class _IntlPhoneFieldState extends State<IntlPhoneField> {
  ...
  void _changeCountryWithoutDialog(Country country) {
    _selectedCountry = country;
    widget.onCountryChanged?.call(country);
    setState(() {});
  ...
  Container _buildFlagsButton() {
    if (widget.country != null && widget.country != _selectedCountry) {
      _changeCountryWithoutDialog(widget.country!);
    }
    return Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                if (widget.showCountryFlag) ...[
                  ...
                  Container(
                    decoration: _selectedCountry.code == 'PK'
                        ? BoxDecoration(
