...
class SharePasswordView extends GetView<DashboardController> {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Text(controller.getWifiListModel
                                      ...
                                      Get.toNamed(Routes.SHARE_PASSWORD,
                                          arguments: {
                                            'pageTitle': controller
                                                ...
                                                .listOfWifi![index]
                                                .name!,
                                            'ssid': controller.getWifiListModel
                                                .listOfWifi![index].name!,
                                            'password': controller
                                                .getWifiListModel
                                                .listOfWifi![index]
                              ...
                              if (controller.allWifiRoomsList.isNotEmpty &&
                                  ((controller.getWifiListModel.listOfWifi!
                                          .length) >
                                      index) &&
                                  controller.allWifiRoomsList.isNotEmpty)
                                ListView.builder(
                                    itemCount: controller
                                        .allWifiRoomsList[index].length,
                                    shrinkWrap: true,
